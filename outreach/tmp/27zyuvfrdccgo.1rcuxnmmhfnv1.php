...
<body>
                ...
                <?php if (isset($vouchers)): ?>
                        ...
                        <span id="voucher-div" name="voucher-div">
                                <?php foreach (($vouchers?:[]) as $voucher): ?>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="form-group col-2">
                                            <label class="form-control-label">Date:</label><input class='form-control' type='text'name='date[]' value="<?= ($voucher[3]) ?>" readonly>
                                        </div>
                                        <div class='form-group col-2'>
                    ...
                    <?php else: ?>
                        ...
                        <div class='row'>
                            ...
                            <div class="form-group col-2">
                                <label class="form-control-label">Date:</label><input class='form-control' type='text' name='date[]'
                                                                                      value="<?= ($dateToday) ?>" readonly>
                            </div>
    ...
    <script>
        ...
        '<div class="row">\n' +
            ...
            '<div class="form-group col-2">\n' +
                '<label class="form-control-label">Date:</label><input class="form-control" type="text" name="date[]" value="'+date+'" readonly>\n' +
            '</div>\n' +
            '<div class="form-group col-2"> \n' +
                '<label class="form-check-label">Resource:</label> \n' +
                '<label class="d-block"></label> \n' +
